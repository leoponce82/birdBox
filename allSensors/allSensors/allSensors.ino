...
volatile uint8_t * const buttonPortInputRegs[BUTTON_PORT_COUNT] = {
  portInputRegister(digitalPinToPort(A4)),
  portInputRegister(digitalPinToPort(A8)),
  portInputRegister(digitalPinToPort(49))
};
...
const uint8_t buttonBitMask[BUTTON_COUNT] = {
  digitalPinToBitMask(A4),  digitalPinToBitMask(A5),  digitalPinToBitMask(A6),  digitalPinToBitMask(A7),
  digitalPinToBitMask(A8),  digitalPinToBitMask(A9),  digitalPinToBitMask(A10), digitalPinToBitMask(A11),
  digitalPinToBitMask(49),  digitalPinToBitMask(47),  digitalPinToBitMask(45),  digitalPinToBitMask(43),
  digitalPinToBitMask(48),  digitalPinToBitMask(46),  digitalPinToBitMask(44),  digitalPinToBitMask(42)
};
